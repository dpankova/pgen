...
pgen.v - main Verilog HDL file with pgen module 

pgen.vt - test bench for pgen.v module (look pgen_present)

pgen_top.v - the top module for quartus project (look pgen_present)
